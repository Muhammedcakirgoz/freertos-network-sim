...
/* Basit bir HTTPS GET istegi atar, cevabin BODY kismini
 * pcCevapBuffer'a yazar. Host ve yol, HER PLATFORMDA duz ASCII/UTF-8
 * char* olarak verilir - Windows implementasyonunun ICINDE gerekirse
 * wide-char donusumu yapilir, uygulama kodu bu detayi HIC GORMEZ.
 * TLS/sertifika dogrulama gibi tum sifreleme islerini bu fonksiyon
 * (platforma gore WinHTTP ya da esp_http_client kullanarak) halleder. */
bool Net_HttpsGet( const char *pcHost, const char *pcYol,
